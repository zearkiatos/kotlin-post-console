...
class CommentRepositoryUnitTest {
    ...
    fun `Given two comments, When created, Then they should be retrievable`() {
        val comment1 = Comment(id = "1", userId = 1, message = "First comment")
        val comment2 = Comment(id = "2", userId = 2, message = "Second comment")
    ...
    fun `Given a comment, When deleted, Then it should not be retrievable`() {
        val comment = Comment(id = "1", userId = 1, message = "First comment")
